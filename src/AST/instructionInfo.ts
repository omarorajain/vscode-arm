...
import { InstructionInfo } from './definitions';

class InstructionInfoImpl implements InstructionInfo {
  ...
  // possible suffixes, conditions, type and width modifiers.
...
export function getInstructionInfo(nameText: string, instructionSet: string): InstructionInfo {
  const instruction = new InstructionInfoImpl(nameText);
